...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,125,4000,500}  // default steps per unit for Ultimaker
...
#define Z_SERVO
#if ENABLED(Z_SERVO)
  #define MINIMUM_PRESSURE 0// in gramme force
  #define MAXIMUM_PRESSURE 300 //in gramme force
  #define PRESSURE_PER_ANGLE 5 //calculated by spring and gear rack can be mesured with balance
  #define START_ANGLE 10 //in degree to define
  #define PRESSURE 80
  #define INVERT_Z_SERVO true // if inverted
  #define LIFT_ANGLE 0
#endif
/*********************************************************************\
* R/C SERVO support
