...
class Servo {
  public:
    ...
    #ifdef HAS_Z_SERVO
    int minPressure = MINIMUM_PRESSURE;
    int maxPressure = MAXIMUM_PRESSURE;
    int8_t startAngle = START_ANGLE;
    int8_t pressurePerAngle = PRESSURE_PER_ANGLE;
    int8_t invert_z_servo = INVERT_Z_SERVO;
    int pressure = PRESSURE;
    int8_t lift_angle = LIFT_ANGLE;
    #endif
